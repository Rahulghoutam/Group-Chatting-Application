...
public class UserThird implements ActionListener, Runnable{
    ...
    UserThird(){
        ...
        ImageIcon i4 = new ImageIcon(ClassLoader.getSystemResource("icon/unnamed.jpg"));
        ...
        JLabel name = new JLabel("Coder Hub");
        name.setBounds(110,15,100,18);
        name.setForeground(Color.WHITE);
        name.setFont(new Font("SAN_SERIF", Font.BOLD,18));
        p1.add(name);
        
        JLabel status = new JLabel("Vikas, Rahul, Amit, Vishnu");
